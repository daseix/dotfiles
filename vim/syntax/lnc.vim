...
syn keyword	lnConfKeyKnown contained command environment pass_environment provides node depends_on term_signal change_directory change_dictionary ready_regex members flags gui name manager verbose2_base depends_on_restart term_timeout use_template start_before undef pipe_include include add add_message_definition_dir rk_domain rk_version rk_base rk_name rk_node rk_arguments rk_no_warnings rk_debug rk_use_template enable_auto_groups member_interfaces "add environment"
